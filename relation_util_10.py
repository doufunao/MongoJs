...
if __name__ == '__main__':
	...
	id_list = [2732096711,2807577540,2013835867,1246025491,1614274951, 247180716, 3481079677, 1235313783, 2526688941, 2806620574]
	...
	for num in range(1,11):
		filepwd = '/'.join([os.getcwd(), 'co_follow_' + str(num) + '_top_10'])
